...
namespace WorksheetGenerator.Elements
{
    public static class El
    {
        ...
        public static Paragraph NumberListItem(int numId, string text)
        {
        ...
        public static List<Paragraph> NumberList(IEnumerable<string> texts)
        {
            List<Paragraph> result = [];

            foreach (string text in texts)
                result.Add(NumberListItem(numberListCount, text));
